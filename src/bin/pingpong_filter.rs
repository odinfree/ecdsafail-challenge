...
impl Model {
    fn new() -> Self {
        ...
        let value_width = |round: usize| -> usize {
            // Exact hard-coded default in the Q1272 selector-eviction source.
...
/// Exact emitted-op identity guard for structural commit `14608572` under
...
const VALIDATED_OPS: usize = 12_908_488;
