...
// New Q793 stream is unmeasured and not yet qualified for publication.
pub(crate) const CANDIDATE_OPS:usize=0; // unmeasured, publication disabled
pub(crate) const CANDIDATE_TOFFOLI:usize=0; // unmeasured
pub(crate) fn candidate_configuration()->bool{false}
