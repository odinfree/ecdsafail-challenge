...
pub fn check(){
 ...
 assert!(saved>0&&saved_t>0);eprintln!("Q793_NCT_FRAME_R01_PASS cube_rules={rules} cube_inputs={cube_checks} random_circuits=4096 exhaustive_inputs=262144 saved_ops={saved} saved_T={saved_t}");
}
