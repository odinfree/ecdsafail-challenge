//! R06: matched conditional-clean general seed plus constant-A1/S1 core with support-proved omission of its empty domain.
...
pub(super) fn signless(circ:&mut Circuit,rank:&[QReg],a:&[QReg],c:&[QReg],sm:&[QReg],p1:&QReg,p2:&QReg,w1:&[QReg],w2:&[QReg],helpers:&[QReg],j:usize,support_end:usize){
    ...
    super::q793_r01_normal_v3::emit(circ,rank,a,c,sm,g,p1,p2,ha,decision,w1,w2,dirty,j,support_end,false);
...
#[path="q793_r01_dynamic_v6_check.rs"] mod check;
