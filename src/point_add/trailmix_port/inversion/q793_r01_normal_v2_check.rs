...
pub(super) fn run(){
    ...
    println!("{{\"kind\":\"Q793 R02 normal R01 external-zero-lease dynamic core\",\"active_lanes\":{total},\"offguard_lanes\":{off},\"shift0_1_2_ge3\":{counts:?},\"A2\":{a2},\"A252_253\":{high_a},\"results\":[{}],\"zero_lease_wrappers_tested\":false,\"whole_q793\":false}}",rows_out.join(","));
