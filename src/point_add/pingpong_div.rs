...
/// Q1272-default width schedule: `WIDTH_SCHEDULE` plus a fitted, peak-safe sparse
/// +1-bit width repair (555 sampled indices, made non-increasing by a
/// right-to-left running-max envelope).  Every soft (hard-clean, width-only)
/// classical fault in the 696/696 stream that is +1-repairable without touching
/// the Q1272 binding plateau (sampled idx 342..345, w=145) is covered.  Measured
/// on the exact fault oracle: held-out corpus-B classical lambda 17.784 -> 14.219
/// (n=320), below the proven-huntable live config's 14.637; peak stays 1272; diag
/// executed Toffoli 914748.17 -> 917491.50.  This table is read only on the
/// shipped width-rescale-on path; `SUB4_PP_WIDTH_RESCALE=0` reads the unrepaired
/// `WIDTH_SCHEDULE`, so the prior live route reproduces byte-for-byte.
const WIDTH_SCHEDULE_Q1272: [u16; 700] = [
    258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 258, 257, 257, 257,
    257, 257, 256, 256, 256, 256, 255, 255, 255, 254, 254, 254, 254, 253, 253, 253, 253, 252, 252, 251, 251, 251, 251, 251, 250,
    250, 249, 249, 248, 248, 248, 248, 247, 247, 247, 246, 246, 246, 246, 246, 245, 245, 244, 244, 244, 243, 243, 243, 242, 242,
    242, 241, 241, 241, 241, 240, 240, 240, 239, 239, 238, 238, 238, 237, 237, 237, 237, 237, 236, 236, 236, 235, 235, 234, 234,
    233, 233, 233, 232, 232, 232, 232, 231, 231, 231, 230, 230, 230, 229, 229, 228, 228, 228, 227, 227, 227, 226, 226, 225, 225,
    225, 225, 224, 224, 223, 223, 223, 223, 222, 222, 222, 221, 221, 221, 220, 220, 220, 219, 219, 218, 218, 218, 218, 217, 217,
    217, 216, 216, 216, 215, 215, 214, 214, 214, 214, 213, 213, 212, 212, 211, 211, 210, 210, 210, 210, 209, 209, 208, 208, 208,
    208, 208, 207, 207, 206, 206, 206, 205, 205, 204, 204, 204, 203, 203, 203, 203, 202, 202, 201, 201, 201, 200, 200, 200, 200,
    199, 199, 198, 198, 197, 197, 197, 196, 196, 195, 195, 195, 195, 194, 194, 194, 194, 193, 193, 192, 192, 191, 191, 191, 191,
    190, 190, 189, 189, 188, 188, 188, 187, 187, 187, 186, 186, 185, 185, 184, 184, 184, 183, 183, 183, 183, 182, 182, 181, 181,
    181, 181, 181, 180, 180, 179, 179, 178, 178, 177, 177, 176, 176, 175, 175, 175, 175, 174, 174, 173, 173, 173, 172, 172, 172,
    171, 171, 170, 170, 170, 169, 169, 169, 168, 168, 168, 168, 167, 167, 166, 166, 165, 165, 165, 164, 164, 163, 163, 162, 162,
    161, 161, 161, 160, 160, 160, 160, 159, 159, 159, 158, 158, 157, 157, 157, 156, 156, 155, 155, 155, 154, 154, 154, 153, 153,
    152, 152, 151, 151, 151, 151, 151, 150, 150, 149, 149, 148, 148, 147, 147, 146, 146, 145, 145, 145, 145, 145, 145, 145, 144,
    144, 143, 143, 143, 142, 142, 141, 141, 141, 140, 140, 139, 139, 138, 138, 138, 137, 137, 136, 136, 136, 135, 135, 135, 134,
    134, 134, 133, 133, 133, 132, 132, 132, 131, 131, 130, 130, 130, 129, 129, 129, 129, 128, 128, 127, 127, 127, 126, 126, 125,
    124, 124, 123, 123, 123, 123, 122, 122, 122, 122, 121, 121, 120, 120, 119, 119, 119, 119, 118, 118, 117, 117, 117, 117, 116,
    116, 115, 115, 115, 114, 114, 113, 113, 112, 112, 112, 112, 111, 111, 111, 111, 110, 110, 110, 109, 109, 108, 108, 107, 107,
    106, 106, 106, 106, 105, 105, 105, 104, 104, 103, 103, 102, 102, 101, 101, 100, 100, 100, 100, 99, 99, 98, 98, 97, 97,
    96, 96, 96, 96, 95, 95, 94, 94, 93, 93, 93, 92, 92, 92, 91, 91, 91, 90, 90, 90, 89, 89, 88, 88, 87,
    87, 87, 86, 86, 86, 85, 85, 84, 84, 84, 84, 83, 83, 82, 82, 81, 80, 80, 80, 79, 79, 78, 78, 77, 77,
    76, 76, 75, 75, 75, 74, 74, 74, 73, 73, 73, 72, 72, 71, 71, 71, 70, 70, 70, 70, 69, 69, 69, 68, 68,
    67, 67, 66, 66, 66, 66, 65, 65, 64, 64, 64, 63, 63, 62, 62, 61, 61, 61, 61, 60, 60, 59, 59, 58, 58,
    57, 57, 56, 56, 56, 55, 55, 55, 54, 54, 53, 53, 53, 52, 52, 51, 51, 51, 50, 50, 49, 49, 49, 48, 48,
    47, 47, 46, 46, 45, 45, 45, 44, 44, 44, 44, 43, 43, 42, 42, 41, 41, 41, 41, 40, 40, 39, 39, 38, 38,
    37, 37, 37, 36, 36, 36, 35, 35, 35, 34, 34, 34, 33, 33, 32, 32, 31, 31, 30, 30, 29, 29, 28, 28, 27,
    27, 26, 26, 26, 26, 25, 25, 24, 24, 23, 23, 22, 22, 21, 21, 21, 20, 20, 19, 19, 19, 18, 18, 17, 17,
    17, 16, 16, 15, 15, 14, 14, 14, 13, 13, 12, 12, 11, 11, 10, 10, 10, 10, 9, 9, 8, 8, 8, 8, 8,
];
...
/// Default width-schedule table for the sampled path.  The shipped Q1272 route
/// (width rescale on) reads the +1-repaired `WIDTH_SCHEDULE_Q1272`; the
/// `SUB4_PP_WIDTH_RESCALE=0` opt-out reads the unrepaired `WIDTH_SCHEDULE`, so
/// the prior live route reproduces byte-for-byte.  Gated on the same env the
/// `width_round_index` compression reads.
fn default_width_table() -> &'static [u16] {
    if std::env::var("SUB4_PP_WIDTH_RESCALE").is_ok_and(|v| v == "0") {
        &WIDTH_SCHEDULE[..]
    } else {
        &WIDTH_SCHEDULE_Q1272[..]
    }
}
...
fn value_width(round: usize) -> usize {
    if std::env::var_os("SUB4_PP_SCHED_LINEAR").is_none() {
        ...
        let table = wsched_override().map_or(default_width_table(), |v| &v[..]);
        if r < table.len() {
...
/// `round*703/695` compression at ROUNDS=696) traversals, through the real
/// `value_width` code path.  Gated by `SUB4_DUMP_WSCHED` in `build`, so it
/// never runs in the shipped stream.
