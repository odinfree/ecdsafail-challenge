...
/// Live carry-ladder budget for those wide adds.  The square is an independent
/// co-binder with the replay plateau, so the Q1276 composition lowers both.
const SQUARE_LADDER: usize = 246;
