...
// Hard identity guards: this build serves exactly the repaired source stream.
static const char PP_SOURCE_COMMIT[] = "fe0b7bac6348fb35b7680784d4295899e498d0e3";
static const char PP_EVIDENCE_COMMIT[] = "d793aa293823b7541c933fa666dd5fc830ac58ea";
static const u64 PP_EXPECTED_OPS_Q1274_REPAIR_R100 = 12920073ULL;
static const char PP_EXPECTED_OPS_SHA256[] =
    "4c68597468ed1dbb4f2e33042842227bf57c011c51f41e9cdaf13c73194b1f8c";
static const u64 PP_EXPECTED_STATE_DIGEST_Q1274_REPAIR_R100 = 0xd2c95102cb9a277dULL;
...
inline void pp_load_prefix(const char* path, PP_Prefix* out) {
    ...
    memcpy(&n, header + 8, 8);
    fclose(f);
    if (n != PP_EXPECTED_OPS_Q1274_REPAIR_R100) {
        fprintf(stderr,
                "ppgpu: FATAL: ops stream op count %llu != expected %llu (q1274-repair-r100); "
    ...
    if (strcmp(file_sha, PP_EXPECTED_OPS_SHA256) != 0) {
        fprintf(stderr,
                ...
                "(q1274-repair-r100); refusing to run on an unknown stream\n",
    ...
    if (digest != PP_EXPECTED_STATE_DIGEST_Q1274_REPAIR_R100) {
        fprintf(stderr,
