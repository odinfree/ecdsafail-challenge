...
// model, ROUNDS_DIV=698/ROUNDS_MUL=696) for the ecdsa.fail Q1274 repaired
// width-schedule stream at source commit fe0b7bac. RTX 4090 (sm_89).
//
...
int main(int argc, char** argv) {
    ...
    // Host prefix load includes exact op count, full-file SHA-256, and
    // parameterized checkpoint-state digest guards.
    PP_Prefix prefix;
