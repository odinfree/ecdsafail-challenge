...
// Hard count + state guard for the exact E007 phase-clean Q1272 stream.
static const u64 PP_EXPECTED_OPS_Q1272 = 12943345ULL; // exact E007 Q1272 phase-clean stream
static const u64 PP_EXPECTED_STATE_DIGEST_Q1272 = 0x963a662d2e392804ULL;
...
inline void pp_load_prefix(const char* path, PP_Prefix* out) {
    ...
    if (n != PP_EXPECTED_OPS_Q1272) {
        fprintf(stderr,
                "ppgpu: FATAL: ops stream op count %llu != expected %llu (q1272-e007); "
    ...
    if (digest != PP_EXPECTED_STATE_DIGEST_Q1272) {
        fprintf(stderr,
                ...
                "(q1272-e007); refusing same-count unknown stream\n",
