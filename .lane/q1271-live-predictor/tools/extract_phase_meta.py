#!/usr/bin/env python3
"""Extract the exact Q1271 conditional-phase schedule from an op-site trace."""
...
EXPECTED_TRACE_SHA256 = "2b5001394244fa510ad1c947c7416e389ae22ef25f854676a47c73c45ecd4c7e"
EXPECTED_TRACED_OPS = 12_926_684
EXPECTED_RHMR = 1_942_543
EXPECTED_COUNTS = (2_923, 694, 694, 3)
FAMILIES = (
    ("point_add/pingpong_div.rs", 1547),
    ("point_add/pingpong_div.rs", 1783),
    ("point_add/pingpong_div.rs", 1927),
