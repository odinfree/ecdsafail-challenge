#!/usr/bin/env python3
"""Seal the exact live-source Q1271 R/Hmr phase schedule."""
...
EXPECTED_META_SHA256 = "2a2b1d5beb5560a4108e78c5cac03b878d684ef6a144bf10a1d1ae4581ae600c"
EXPECTED_OPS = 12_926_780
EXPECTED_RHMR = 1_942_543
EXPECTED_COUNTS = (2_923, 694, 694, 3)
SOURCE_LINES = (1547, 1783, 1927, 1501)
...
def main() -> None:
    ...
    out = [
        "#pragma once\n\n",
        "// Generated from the exact live-source Q1271 source/stream trace.\n",
        "// source: b69c17e16e0b9140d14f15c7d87314352ecaf7be\n",
        "// ops.bin sha256: a13de41544a81672b07674acabecec0bb054201b8d1634ed79745bbc4be2f23e\n",
