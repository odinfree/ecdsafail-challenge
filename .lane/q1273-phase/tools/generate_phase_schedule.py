#!/usr/bin/env python3
"""Seal the exact Q1273 R/Hmr phase schedule into a C++ header and ledger."""
...
EXPECTED_META_SHA256 = "a4043530337b91e97d7a42dde2aff7e5a967a0b820ad1a9a120b3c366d7a5294"
EXPECTED_OPS = 12_933_805
EXPECTED_RHMR = 1_942_962
EXPECTED_COUNTS = (2_590, 696, 694, 3)
SOURCE_LINES = (1547, 1783, 1898, 1501)
...
def main() -> None:
    ...
    out = [
        "#pragma once\n\n",
        "// Generated from the exact Q1273 source/stream trace.\n",
        "// source: 093d85d64de87aa5006a94868172f642daacf136\n",
        "// ops.bin sha256: ee6448dbb23aa877123733724b109266e584f1ba14abf5c38b43b9ab6aa26cd1\n",
