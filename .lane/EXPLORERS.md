...
| 4 | E-012 phase-clean call-9 carry | Attribute E-011 lane4 to an exact cleanup site, then correct only complemented-AND measurement erasure with conditioned `NEG`. | Zero additional T expected; about 386 diagnostic T remains after E-011. | Frozen 8-lane phase/dirty gate, square64, then Q1272/live-T diagnostic. | predeclared; no source edit |
