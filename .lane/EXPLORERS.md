...
| 4 | E-006 final-y boundary borrow | Preserve one borrow qubit across the low53/high203 split, decrement the high suffix, then erase the borrow from corrected low bits. | Static bound: final phase Q≤1186, incremental T≤930, projected rounded full T≤917113. | Original fixed inputs 7996/7997 must both become exact with phase/dirty `0/0` before profiling. | predeclared |
