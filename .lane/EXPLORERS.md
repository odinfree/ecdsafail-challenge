...
| 4 | E-013 pre-propagation overflow erasure | Run inherited overflow HMR/comparator before high200 mutation; temporarily restore its measured control for the live ladder reverse. | Static zero T over E-011; two classically conditioned X, no extra coherent qubit. | Frozen repaired-seed 8-lane phase/dirty gate, square64, then Q1272/live-T composition. | predeclared; no source edit |
