...
| 4 | E-004 square/result isolation | Localize E-001c nonce `444000000032`, shot 7997 across square versus final coordinate shell before changing a window. | No source cost until attribution; square is a Q1272 co-binder. | Fixed-shot intermediate miter, then the smallest attributed repair only. | next |
