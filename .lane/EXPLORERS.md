...
| 4 | E-011 explicit call-9 carry | Preserve the low56 `+f` carry at final C-half reduction and propagate it through high200 without shifting the boundary. | Hard live allowance: <=992 rounded T; call-local Q901 under global Q1272. | Pinned pair, non-tied exact bit56/57 miter, frozen square64, then conditional full/H64. | gates predeclared; no source edit |
