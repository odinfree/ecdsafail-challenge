...
// Hard identity guards: this build serves exactly the Q1273 replay-square stream.
static const char PP_SOURCE_COMMIT[] = "093d85d64de87aa5006a94868172f642daacf136";
static const char PP_EVIDENCE_COMMIT[] = "a8f7307f0a93ec78910444b2e4c18a78f70b9ae9";
static const u64 PP_EXPECTED_OPS = 12933805ULL;
...
inline void pp_load_prefix(const char* path, PP_Prefix* out) {
    ...
    if (n != PP_EXPECTED_OPS) {
        fprintf(stderr,
                "ppcpu: FATAL: ops stream op count %llu != expected %llu (q1273-redescent); "
    ...
    if (strcmp(file_sha, PP_EXPECTED_OPS_SHA256) != 0) {
        fprintf(stderr,
                ...
                "(q1273-redescent); refusing to run on an unknown stream\n",
