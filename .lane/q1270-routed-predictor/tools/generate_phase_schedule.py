#!/usr/bin/env python3
"""Seal the exact Q1270 routed-stream R/Hmr phase schedule."""
...
EXPECTED_META_SHA256 = "fba2270e4c4fed53db5625612c72b930dc821bb8c54c4ed43df5855f845bca0b"
EXPECTED_OPS = 12_953_636
EXPECTED_RHMR = 1_947_720
EXPECTED_COUNTS = (3_267, 694, 694, 3)
SOURCE_LINES = (1585, 1854, 2031, 1501)
...
def main() -> None:
    ...
    for number, line in enumerate(text.splitlines(), 1):
        ...
        if op_index >= EXPECTED_OPS - 96 or ordinal >= EXPECTED_RHMR:
    ...
    out = [
        "#pragma once\n\n",
        "// Generated from the exact source-bound Q1270 routed stream.\n",
        "// source: 90770b10664fc89065b1d05ac792370efed4c629\n",
        "// ops.bin sha256: ec4fadc0b5cd1c26ee5d81001b7a72692678b61a94c4091032dd93b8b62eb63a\n",
