// pp_host.h — host-only helpers for the exact live-source Q1272 stream.
...
// Hard identity guards: this build serves exactly the Q1272 selector stream.
static const char PP_SOURCE_COMMIT[] = "73422709ed70ba9725b3cb592770bcf197df4cdb";
static const char PP_EVIDENCE_COMMIT[] = "41dd0b4508527081b8d24255adf0579389f02453";
static const u64 PP_EXPECTED_OPS = 12904643ULL;
...
#define PP_EXPECTED_STATE_DIGEST_VALUE 0xe9b2d20ecd1169a8ULL
#endif
...
inline void pp_load_prefix(const char* path, PP_Prefix* out) {
    ...
    if (n != PP_EXPECTED_OPS) {
        fprintf(stderr,
                "ppcpu: FATAL: ops stream op count %llu != expected %llu (q1272-live-phase); "
    ...
    if (strcmp(file_sha, PP_EXPECTED_OPS_SHA256) != 0) {
        fprintf(stderr,
                ...
                "(q1272-live-phase); refusing to run on an unknown stream\n",
